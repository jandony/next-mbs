    ...
    return (
        <div className={`${className} h-full`}>
            <div
                className={
                    halfCircleIcon
                        ? 'p-[25px] bg-white dark:bg-white/10 rounded-10 relative text-[15px] text-theme-gray dark:text-white/60 leading-6 h-full'
                        : 'p-[25px] bg-white dark:bg-white/10 rounded-10 relative text-[15px] text-theme-gray dark:text-white/60 leading-6 h-full'
                }
            >
                    ...
                    <div className={contentFirst ? '' : 'text-end'}>
                        {halfCircleIcon ? (
                            ...
                            <>
                                ...
                                <span className="font-normal text-body dark:text-white/60 text-15">
                                    {label}
                                </span>
                            </>
                        )}
                ...
                {bottomStatus ? (
                    <div className="mt-3">
                        <span className="inline-flex items-center w-full h-11 bg-gray-50 dark:bg-white/[.06]  px-2.5 rounded-lg">
                            <span
                                className={`flex items-center text-sm font-medium text-${statusColor}`}
                            >
                                {status === 'growth' ? (
                            ...
                            <span className="ml-2.5 text-light dark:text-white/60 text-sm">
                                {dataPeriod}
                            </span>
                        </span>
                    </div>
