...
import DashboardChart from '@/app/components/antd/charts/DashboardChart';
import { Cards } from '@/app/components/antd/cards/frame/cards-frame';
import { customTooltips } from '@/app/components/antd/utilities';
    ...
    const moreContent = [
        {
            ...
            label: (
                <Link
                    ...
                    href="#"
                >
                    <UilPrint className="w-3.5 h-3.5 mr-2" />
                    <span>Printer</span>
                </Link>
            ),
        },
        {
            ...
            label: (
                <Link
                    ...
                    href="#"
                >
                    <UilBookOpen className="w-3.5 h-3.5 mr-2" />
                    <span>PDF</span>
                </Link>
            ),
        },
        {
            ...
            label: (
                <Link
                    ...
                    href="#"
                >
                    <UilFileAlt className="w-3.5 h-3.5 mr-2" />
        ...
        },
        {
            ...
            label: (
                <Link
                    ...
                    href="#"
                >
                    <UilTimes className="w-3.5 h-3.5 mr-2" />
        ...
        },
        {
            ...
            label: (
                <Link
                    ...
                    href="#"
                >
                    <UilFile className="w-3.5 h-3.5 mr-2" />
                    <span>CSV</span>
                </Link>
            ),
        },
                ...
                >
                    <div className="flex items-center justify-center ssm:flex-col ssm:gap-y-[15px]">
                        <div className="relative flex items-center me-3 gap-[15px]">
                            <span className="flex items-center text-sm pl-3 text-body dark:text-white/60 before:absolute before:bg-primary before:w-2 before:h-2 before:rounded-full before:left-0 before:top-1/2 before:-translate-y-2/4">
                                Orders
                            </span>
                            <span className="inline-block text-dark dark:text-white/[.87] mr-1 ml-2.5 text-22 font-semibold">
                                $8,550
                            </span>
                        ...
                        <div className="relative flex items-center me-3">
                            <span className="flex items-center text-sm pl-3 text-body dark:text-white/60 before:absolute before:bg-info before:w-2 before:h-2 before:rounded-full before:left-0  before:top-1/2 before:-translate-y-2/4">
                                Sales
                            </span>
                            <span className="inline-block text-dark dark:text-white/[.87] mr-1 ml-2.5 text-22 font-semibold">
                                $5,550
