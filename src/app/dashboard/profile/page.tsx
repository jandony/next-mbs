...
const columns = [
    {
        ...
        key: 'name',
        className:
            'text-[14px] font-normal dark:text-white/60 dark:border-white/10 dark:[th&]:text-white before:hidden px-[25px] [th&]:text-primary [th&]:font-bold [th&]:text-[15px]',
    },
    {
        title: 'Price',
        dataIndex: 'price',
    ...
    return (
        <Row gutter={25}>
            <Col xxl={8} lg={12} md={24} sm={12} xs={24}>
                <div className="flex flex-wrap items-end bg-white dark:bg-white/10 rounded-10 p-[25px] mb-[25px]">
